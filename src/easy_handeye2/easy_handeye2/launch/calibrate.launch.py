...
def generate_launch_description():
    ...
    arg_eye_in_hand = DeclareLaunchArgument('eye_in_hand', default_value=TextSubstitution(text="true"))
    arg_tracking_base_frame = DeclareLaunchArgument('tracking_base_frame', default_value=TextSubstitution(text="camera_link"))
    arg_tracking_marker_frame = DeclareLaunchArgument('tracking_marker_frame', default_value=TextSubstitution(text="tag0"))
    arg_robot_base_frame = DeclareLaunchArgument('robot_base_frame', default_value=TextSubstitution(text="base"))
    arg_robot_effector_frame = DeclareLaunchArgument('robot_effector_frame', default_value=TextSubstitution(text="flange"))
